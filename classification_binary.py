...
cv_results_catboost = cross_validate(catboost_classifier, X_resampled, y_resampled, cv=10, scoring=scoring)  # <-- Cross-Validation für CatBoost
y_pred_catboost = cross_val_predict(catboost_classifier, X_resampled, y_resampled, cv=10)  # <-- Vorhersagen für CatBoost
