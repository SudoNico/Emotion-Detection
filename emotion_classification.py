...
data = pd.read_csv('/Users/chanti/Desktop/5. Semester/Softwareprojekt/Code/Emotion-Detection/intermediate_results/preprocessed_results_multi.txt', sep=',', header=None)
...
for fold, (train_index, test_index) in enumerate(kf.split(X)):
    ...
    # Daten skalieren
    scaler = StandardScaler(with_mean=False)  # Sparse-Matrix
